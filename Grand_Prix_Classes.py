...
# Ticket Class
class Ticket:
    """Class to represent a Ticket that contains a composed Payment object."""

    # Constructor
    def __init__(self, ticket_type, ticket_id, ticket_price, discounted_amount,
                 payment_method, payment_id, discount_description):
        self.__ticket_type = ticket_type
        self.__ticket_id = ticket_id
        self.__ticket_price = ticket_price
        self.__discounted_amount = discounted_amount

        # Composition: create Payment object inside Ticket
        self.__payment = Payment(payment_method, payment_id, date.today(), discount_description)
    ...
    def set_discounted_amount(self, discount):
        self.__discounted_amount = discount
    ...
    def get_payment(self):
        return self.__payment  # Provides access to the composed Payment object
    ...
    def __str__(self):
        return (f"Ticket[ID: {self.__ticket_id}, Type: {self.__ticket_type.value}, "
                f"Price: {self.__ticket_price}, Discount: {self.__discounted_amount}]")
