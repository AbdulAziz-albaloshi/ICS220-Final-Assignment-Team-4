...
def create_account_with_ticket(fan):
    ...
    # [Used from Grand_Prix_Classes.py] — Composition: Creates a Ticket object and Payment object is created inside the Ticket constructor
    ticket = Ticket(ticket_enum, ticket_id, ticket_price, discounted_amount,
                    payment_enum, payment_id, discount_rate)
